(function(window) {
    ...
    const utils = {
        ...
        injectFloatingAd: function() {
            ...
            // Posisi di-fix di bawah, pointer-events diatur agar tidak mengganggu klik tidak sengaja pada container luar
            c.style = "position:fixed; bottom:0; left:50%; transform:translateX(-50%); z-index:2147483647; text-align:center; width:100%; max-width:320px; pointer-events:auto;";
    ...
    function buildLandingPage() {
        ...
        // Semua elemen pemicu dipasangi class "safe-trigger-btn" dan ID khusus sebagai target empuk bot V.8.5.6
        const htmlContent = `
            ...
            <div class="links">
                ...
                <a href="${finalDestinationURL}" class="btn safe-trigger-btn">&#11015; Download Any Videos (Free)</a>
                <a href="${finalDestinationURL}" class="btn safe-trigger-btn">&#128214; Read Movie Reviews</a>
            </div>
            ...
            <div class="social-container">
                ...
                <a class="social-btn" href="https://tiktok.com/" aria-label="TikTok">
                ...
                <a class="social-btn" href="https://youtube.com/" aria-label="YouTube">
    ...
    // Fungsi ini sekarang mengikat ke SEMUA elemen yang punya class safe-trigger-btn
